...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::release::get_release_context,
            commands::release::polish_changelog,
            commands::release::start_release,
            commands::release::list_releases,
            commands::release::get_publish_settings,
            commands::release::set_publish_settings,
            commands::release::verify_github_pat,
